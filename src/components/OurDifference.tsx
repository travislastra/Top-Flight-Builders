...
const differentiators = [
  {
    photo: "/images/projects/more-from-us/topflight-builders-remodeling-project-marietta-ga-02.jpg",
    icon: (
  ...
  {
    photo: "/images/projects/more-from-us/topflight-builders-remodeling-project-marietta-ga-07.jpg",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    photo: "/images/projects/more-from-us/topflight-builders-remodeling-project-marietta-ga-13.jpg",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    photo: "/images/projects/more-from-us/topflight-builders-remodeling-project-marietta-ga-19.jpg",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
