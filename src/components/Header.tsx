      ...
      <div className="flex items-center justify-between lg:grid lg:grid-cols-3 px-4 lg:px-10 py-1">
          ...
          {navItems.map((item) => (
            ...
            >
              {item.children ? (
                <Link
                  href={item.href}
                  className="flex items-center gap-1 px-3 py-3 min-h-[44px] text-lg font-semibold text-gray-200 hover:text-white hover:bg-white/10 rounded transition-colors uppercase tracking-wide"
                >
                  {item.label}
                ...
                <Link
                  href={item.href}
                  className="px-3 py-3 min-h-[44px] text-lg font-semibold text-gray-200 hover:text-white hover:bg-white/10 rounded transition-colors uppercase tracking-wide block"
                >
                  {item.label}
                </Link>
              )}
        ...
        <div className="hidden lg:flex items-center justify-end gap-4">
          ...
          <div className="flex items-center gap-3">
            <a href="https://www.facebook.com/TopFlightBuildersLLC" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-400 hover:text-white transition-colors inline-flex items-center justify-center w-11 h-11">
            ...
            <a href="https://www.instagram.com/topflightbuildersllc/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 hover:text-white transition-colors inline-flex items-center justify-center w-11 h-11">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.houzz.com/professionals/general-contractors/topflight-builders-llc-pfvwus-pf~726210190" target="_blank" rel="noopener noreferrer" aria-label="Houzz" className="text-gray-400 hover:text-white transition-colors inline-flex items-center justify-center w-11 h-11">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.tiktok.com/@topflightbuildersatl" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-gray-400 hover:text-white transition-colors inline-flex items-center justify-center w-11 h-11">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
