...
export const metadata = {
  ...
  openGraph: {
    ...
    description: "Kitchen, bathroom, and whole-home remodeling in East Cobb, GA by TopFlight Builders. Serving Lassiter, Pope, and Walton school zones. Licensed, insured, 50+ reviews. (404) 369-7129.",
    images: [{ url: "https://topflightbuilders.net/images/bathroom-remodel-frameless-glass-shower-marietta-ga.jpg", width: 1200, height: 630, alt: "Remodeling contractor in East Cobb, GA — TopFlight Builders" }],
  },
  alternates: {
    canonical:
