        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="grid grid-cols-2 gap-3">
            <div className="relative aspect-square rounded-xl overflow-hidden">
              <Img src="/images/bathroom-remodel-frameless-glass-shower-marietta-ga.jpg" alt="Bathroom remodel" fill className="object-cover" />
            </div>
            <div className="relative aspect-square rounded-xl overflow-hidden mt-6">
              <Img src="/images/bathroom-remodel-custom-tile-shower-chamblee-ga.jpg" alt="Luxury shower" fill className="object-cover" />
            </div>
          </div>
          <div>
