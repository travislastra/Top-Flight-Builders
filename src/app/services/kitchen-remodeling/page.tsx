      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="relative aspect-square rounded-xl overflow-hidden mt-6 bg-[#0D1B2E] flex items-center justify-center">
              <div className="text-center px-4">
                ...
                <p className="text-white/30 text-xs font-semibold uppercase tracking-wider">Photo Coming Soon</p>
              </div>
            </div>
          </div>
        </div>
