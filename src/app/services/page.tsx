...
const services = [
  ...
  },
  {
    ...
    photo: "/images/projects/bathroom-buckhead/bathroom-remodel-buckhead-ga-02.jpg",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    photo: "/images/projects/whole-home-east-cobb/whole-home-renovation-east-cobb-ga-03.jpg",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    photo: "/images/projects/basement-east-cobb/basement-finishing-east-cobb-ga-05.jpg",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    photo: "/images/age-in-place-grab-bars-accessible-bathroom-marietta-ga.jpg",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
